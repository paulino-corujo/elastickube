...
import AdminEditNamespaceDirective from './ek-admin-edit-namespace/ek-admin-edit-namespace.directive';
...
import NamespaceActionsDirective from './ek-namespace-actions/ek-namespace-actions.directive';
...
angular
    ...
    .directive('ekAdminEditNamespace', () => new AdminEditNamespaceDirective())
    ...
    .directive('ekNamespaceActions', () => new NamespaceActionsDirective());
