...
class NamespacesActionCreatorService {
    constructor(actions, confirmDialog, dispatcher, namespacesAPI) {
        ...
        namespacesAPI.addOnCreatedListener((namespace) => this._dispatcher.dispatch({ type: this._actions.NAMESPACE_CREATED, namespace }));
    ...
    createNamespace(namespaceName, members) {
        ...
        this._dispatcher.dispatch({ type: this._actions.NAMESPACE_CREATE });

        return this._namespacesAPI.create(createBody)
            .then((namespace) => this._dispatcher.dispatch({ type: this._actions.NAMESPACE_CREATED, namespace }));
    }
}
